        ...
        >
          <div>
            <div className="flex flex-col w-full mt-4 ml-8">
              ...
              <p className="max-w-2xl py-4 text-lg leading-normal text-gray-100 lg:text-xl xl:text-xl dark:text-gray-600">
                {data.desc}
              </p>
            </div>
  ...
  return (
    <>
      <div className="flex items-start mt-8 space-x-3">
        <div className="flex items-center justify-center flex-shrink-0 mt-1 bg-orange-700  rounded-md w-11 h-11 ">
